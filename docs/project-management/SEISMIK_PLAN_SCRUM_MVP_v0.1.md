...
Horizonte: 8 sprints / 15 semanas  
Cadencia: Sprint 0 de 1 semana y Sprints 1–7 de 2 semanas
...
## 15. Product Backlog posterior al MVP
...
| 7 | iOS y proceso Critical Alerts | Expansión |
| 8 | Cobertura regional/mundial progresiva | Expansión |
| 9 | API Research comercial y exportaciones | Expansión |
| 10 | IoT supervisado con fabricante | IoT seguro |
...
|---|---|---|---|
| Product Owner | Pendiente | Pendiente | Aprobar ocho sprints y responsabilidades |
| Responsable técnico | Elaborado | 2026-08-23 | Plan sujeto a refinamiento por Sprint |
